...
public class Numbers{
    ...
    static String numbers[] = {"nye","bili","thathu","ne","hlanu","thupha","khombisa","shiyagalombili","shiyagalolunye","shumi","khulu","kulungwane"};
    public static void main(String[] args){
        ...
        //Singles
        if(lengthOfNumber==1){
            String word = individualNumbers(number);
